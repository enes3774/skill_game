...
function PlayerTracker(gameServer, socket) {
    ...
    this.privyId = null;           // Privy user ID for authentication
    this.walletAddress = null;      // Solana wallet address
    this.monetaryValue = 0;         // Current SOL value in game
    this.authenticated = false;      // Authentication status
    this.initialDeposit = 0;        // Entry amount deposited
    this.totalKills = 0;            // Total kills this session
    this.totalDeaths = 0;           // Total deaths this session
    this.gameId = null;             // Current game ID for database
    this.depositSignature = null;   // Blockchain deposit tx signature
